...
***/
package com.yapa.space.api.graphics;
...
public class Geometry {
    ...
    public static class Rect3d {
        public Vector mCenter = new Vector(0, 0, 0);

        // mSize[0] leftLen 
        // mSize[1] upLen
        // mSize[2] rightLen
        // mSize[3] bottonLen
        public float mLeftUpRightBotton[] = new float[] {1, 1, 1, 1};
    }

    public static class PlaneXY3d {
        public Vector mStartVector = new Vector(1, 0, 0);
        public Vector mEndVector = new Vector(0, 1, 0);
    }
